    ...
    namespace
    {
        int _tmain(int argc, TCHAR *argv[])
        {
            ...
            while (1)
            {
                ...
                {
                    throw cm::ChannelException(std::string("Could not open pipe. GLE=")+ std::to_string(GetLastError()));
                }
                ...
                {
                    throw cm::ChannelException(std::string("Could not open pipe: 20 second wait timed out."));
                }
            }
